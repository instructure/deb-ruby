...
%type <val> literal numeric simple_numeric ssym dsym symbol cpath def_name defn_head defs_head
...
%type <val> f_arglist f_opt_paren_args f_paren_args f_args f_arg f_arg_item
%type <val> f_optarg f_marg f_marg_list f_margs f_rest_marg
...
%type <val>   f_no_kwarg f_any_kwrest args_forward excessed_comma nonlocal_var
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=$4;v2=$6;v3=dispatch2(rescue_mod,v1,v2);v4=$1;v5=v3;v6=dispatch2(massign,v4,v5);$$=v6;}
                    }
...
command_asgn	: lhs '=' lex_ctxt command_rhs
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7;v1=$1;v2=escape_Qundef($3);v3=dispatch2(aref_field,v1,v2);v4=v3;v5=$5;v6=$7;v7=dispatch3(opassign,v4,v5,v6);$$=v7;}
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7,v8,v9;v1=$4;v2=Qnil;v3=Qnil;v4=Qnil;v5=dispatch4(bodystmt,v1,v2,v3,v4);v6=get_value($1);v7=$2;v8=v5;v9=dispatch3(def,v6,v7,v8);$$=v9;}
                        local_pop(p);
                    }
			...
			{VALUE v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11;v1=$4;v2=Qnil;v3=Qnil;v4=Qnil;v5=dispatch4(bodystmt,v1,v2,v3,v4);v6=AREF($1, 0);v7=AREF($1, 1);v8=AREF($1, 2);v9=$2;v10=v5;v11=dispatch5(defs,v6,v7,v8,v9,v10);$$=v11;}
                        local_pop(p);
                    }
...
primary		: literal
                  ...
                  k_end
                    {
                        ...
                        $$ = set_defun_body(p, $1, $2, $4, &@$);
#endif
			{VALUE v1,v2,v3,v4;v1=get_value($1);v2=$2;v3=$4;v4=dispatch3(def,v1,v2,v3);$$=v4;}
                        local_pop(p);
                    }
                | defs_head
                  f_arglist
			...
			{VALUE v1,v2,v3,v4,v5,v6;v1=AREF($1, 0);v2=AREF($1, 1);v3=AREF($1, 2);v4=$2;v5=$4;v6=dispatch5(defs,v1,v2,v3,v4,v5);$$=v6;}
                        local_pop(p);
                    }
                | keyword_break
                    {
                  ...
                  p_cases
                    {
                        ...
                        $$ = NEW_IN($4, $7, $8, &@$);
#endif
			{VALUE v1,v2,v3,v4;v1=$4;v2=$7;v3=escape_Qundef($8);v4=dispatch3(in,v1,v2,v3);$$=v4;}
                    }
                ;
