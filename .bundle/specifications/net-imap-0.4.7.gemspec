...
Gem::Specification.new do |s|
  ...
  s.files = [".github/dependabot.yml".freeze, ".github/workflows/pages.yml".freeze, ".github/workflows/test.yml".freeze, ".gitignore".freeze, "Gemfile".freeze, "LICENSE.txt".freeze, "README.md".freeze, "Rakefile".freeze, "docs/styles.css".freeze, "lib/net/imap.rb".freeze, "lib/net/imap/authenticators.rb".freeze, "lib/net/imap/command_data.rb".freeze, "lib/net/imap/data_encoding.rb".freeze, "lib/net/imap/deprecated_client_options.rb".freeze, "lib/net/imap/errors.rb".freeze, "lib/net/imap/fetch_data.rb".freeze, "lib/net/imap/flags.rb".freeze, "lib/net/imap/response_data.rb".freeze, "lib/net/imap/response_parser.rb".freeze, "lib/net/imap/response_parser/parser_utils.rb".freeze, "lib/net/imap/sasl.rb".freeze, "lib/net/imap/sasl/anonymous_authenticator.rb".freeze, "lib/net/imap/sasl/authentication_exchange.rb".freeze, "lib/net/imap/sasl/authenticators.rb".freeze, "lib/net/imap/sasl/client_adapter.rb".freeze, "lib/net/imap/sasl/cram_md5_authenticator.rb".freeze, "lib/net/imap/sasl/digest_md5_authenticator.rb".freeze, "lib/net/imap/sasl/external_authenticator.rb".freeze, "lib/net/imap/sasl/gs2_header.rb".freeze, "lib/net/imap/sasl/login_authenticator.rb".freeze, "lib/net/imap/sasl/oauthbearer_authenticator.rb".freeze, "lib/net/imap/sasl/plain_authenticator.rb".freeze, "lib/net/imap/sasl/protocol_adapters.rb".freeze, "lib/net/imap/sasl/scram_algorithm.rb".freeze, "lib/net/imap/sasl/scram_authenticator.rb".freeze, "lib/net/imap/sasl/stringprep.rb".freeze, "lib/net/imap/sasl/xoauth2_authenticator.rb".freeze, "lib/net/imap/sasl_adapter.rb".freeze, "lib/net/imap/sequence_set.rb".freeze, "lib/net/imap/stringprep.rb".freeze, "lib/net/imap/stringprep/nameprep.rb".freeze, "lib/net/imap/stringprep/saslprep.rb".freeze, "lib/net/imap/stringprep/saslprep_tables.rb".freeze, "lib/net/imap/stringprep/tables.rb".freeze, "lib/net/imap/stringprep/trace.rb".freeze, "net-imap.gemspec".freeze, "rakelib/benchmarks.rake".freeze, "rakelib/rdoc.rake".freeze, "rakelib/rfcs.rake".freeze, "rakelib/saslprep.rake".freeze, "rakelib/string_prep_tables_generator.rb".freeze]
