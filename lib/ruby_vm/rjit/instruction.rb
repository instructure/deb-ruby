module RubyVM::RJIT # :nodoc: all
  ...
  INSNS = {
    ...
    101 => Instruction.new(
      name: :trace_nop,
      bin: 101, # BIN(trace_nop)
      len: 1, # insn_len
      operands: nil,
    ),
    102 => Instruction.new(
      name: :trace_getlocal,
      bin: 102, # BIN(trace_getlocal)
      len: 3, # insn_len
      operands: nil,
    ),
    103 => Instruction.new(
      name: :trace_setlocal,
      bin: 103, # BIN(trace_setlocal)
      len: 3, # insn_len
      operands: nil,
    ),
    104 => Instruction.new(
      name: :trace_getblockparam,
      bin: 104, # BIN(trace_getblockparam)
      len: 3, # insn_len
      operands: nil,
    ),
    105 => Instruction.new(
      name: :trace_setblockparam,
      bin: 105, # BIN(trace_setblockparam)
      len: 3, # insn_len
      operands: nil,
    ),
    106 => Instruction.new(
      name: :trace_getblockparamproxy,
      bin: 106, # BIN(trace_getblockparamproxy)
      len: 3, # insn_len
      operands: nil,
    ),
    107 => Instruction.new(
      name: :trace_getspecial,
      bin: 107, # BIN(trace_getspecial)
      len: 3, # insn_len
      operands: nil,
    ),
    108 => Instruction.new(
      name: :trace_setspecial,
      bin: 108, # BIN(trace_setspecial)
      len: 2, # insn_len
      operands: nil,
    ),
    109 => Instruction.new(
      name: :trace_getinstancevariable,
      bin: 109, # BIN(trace_getinstancevariable)
      len: 3, # insn_len
      operands: nil,
    ),
    110 => Instruction.new(
      name: :trace_setinstancevariable,
      bin: 110, # BIN(trace_setinstancevariable)
      len: 3, # insn_len
      operands: nil,
    ),
    111 => Instruction.new(
      name: :trace_getclassvariable,
      bin: 111, # BIN(trace_getclassvariable)
      len: 3, # insn_len
      operands: nil,
    ),
    112 => Instruction.new(
      name: :trace_setclassvariable,
      bin: 112, # BIN(trace_setclassvariable)
      len: 3, # insn_len
      operands: nil,
    ),
    113 => Instruction.new(
      name: :trace_opt_getconstant_path,
      bin: 113, # BIN(trace_opt_getconstant_path)
      len: 2, # insn_len
      operands: nil,
    ),
    114 => Instruction.new(
      name: :trace_getconstant,
      bin: 114, # BIN(trace_getconstant)
      len: 2, # insn_len
      operands: nil,
    ),
    115 => Instruction.new(
      name: :trace_setconstant,
      bin: 115, # BIN(trace_setconstant)
      len: 2, # insn_len
      operands: nil,
    ),
    116 => Instruction.new(
      name: :trace_getglobal,
      bin: 116, # BIN(trace_getglobal)
      len: 2, # insn_len
      operands: nil,
    ),
    117 => Instruction.new(
      name: :trace_setglobal,
      bin: 117, # BIN(trace_setglobal)
      len: 2, # insn_len
      operands: nil,
    ),
    118 => Instruction.new(
      name: :trace_putnil,
      bin: 118, # BIN(trace_putnil)
      len: 1, # insn_len
      operands: nil,
    ),
    119 => Instruction.new(
      name: :trace_putself,
      bin: 119, # BIN(trace_putself)
      len: 1, # insn_len
      operands: nil,
    ),
    120 => Instruction.new(
      name: :trace_putobject,
      bin: 120, # BIN(trace_putobject)
      len: 2, # insn_len
      operands: nil,
    ),
    121 => Instruction.new(
      name: :trace_putspecialobject,
      bin: 121, # BIN(trace_putspecialobject)
      len: 2, # insn_len
      operands: nil,
    ),
    122 => Instruction.new(
      name: :trace_putstring,
      bin: 122, # BIN(trace_putstring)
      len: 2, # insn_len
      operands: nil,
    ),
    123 => Instruction.new(
      name: :trace_concatstrings,
      bin: 123, # BIN(trace_concatstrings)
      len: 2, # insn_len
      operands: nil,
    ),
    124 => Instruction.new(
      name: :trace_anytostring,
      bin: 124, # BIN(trace_anytostring)
      len: 1, # insn_len
      operands: nil,
    ),
    125 => Instruction.new(
      name: :trace_toregexp,
      bin: 125, # BIN(trace_toregexp)
      len: 3, # insn_len
      operands: nil,
    ),
    126 => Instruction.new(
      name: :trace_intern,
      bin: 126, # BIN(trace_intern)
      len: 1, # insn_len
      operands: nil,
    ),
    127 => Instruction.new(
      name: :trace_newarray,
      bin: 127, # BIN(trace_newarray)
      len: 2, # insn_len
      operands: nil,
    ),
    128 => Instruction.new(
      name: :trace_newarraykwsplat,
      bin: 128, # BIN(trace_newarraykwsplat)
      len: 2, # insn_len
      operands: nil,
    ),
    129 => Instruction.new(
      name: :trace_duparray,
      bin: 129, # BIN(trace_duparray)
      len: 2, # insn_len
      operands: nil,
    ),
    130 => Instruction.new(
      name: :trace_duphash,
      bin: 130, # BIN(trace_duphash)
      len: 2, # insn_len
      operands: nil,
    ),
    131 => Instruction.new(
      name: :trace_expandarray,
      bin: 131, # BIN(trace_expandarray)
      len: 3, # insn_len
      operands: nil,
    ),
    132 => Instruction.new(
      name: :trace_concatarray,
      bin: 132, # BIN(trace_concatarray)
      len: 1, # insn_len
      operands: nil,
    ),
    133 => Instruction.new(
      name: :trace_splatarray,
      bin: 133, # BIN(trace_splatarray)
      len: 2, # insn_len
      operands: nil,
    ),
    134 => Instruction.new(
      name: :trace_newhash,
      bin: 134, # BIN(trace_newhash)
      len: 2, # insn_len
      operands: nil,
    ),
    135 => Instruction.new(
      name: :trace_newrange,
      bin: 135, # BIN(trace_newrange)
      len: 2, # insn_len
      operands: nil,
    ),
    136 => Instruction.new(
      name: :trace_pop,
      bin: 136, # BIN(trace_pop)
      len: 1, # insn_len
      operands: nil,
    ),
    137 => Instruction.new(
      name: :trace_dup,
      bin: 137, # BIN(trace_dup)
      len: 1, # insn_len
      operands: nil,
    ),
    138 => Instruction.new(
      name: :trace_dupn,
      bin: 138, # BIN(trace_dupn)
      len: 2, # insn_len
      operands: nil,
    ),
    139 => Instruction.new(
      name: :trace_swap,
      bin: 139, # BIN(trace_swap)
      len: 1, # insn_len
      operands: nil,
    ),
    140 => Instruction.new(
      name: :trace_opt_reverse,
      bin: 140, # BIN(trace_opt_reverse)
      len: 2, # insn_len
      operands: nil,
    ),
    141 => Instruction.new(
      name: :trace_topn,
      bin: 141, # BIN(trace_topn)
      len: 2, # insn_len
      operands: nil,
    ),
    142 => Instruction.new(
      name: :trace_setn,
      bin: 142, # BIN(trace_setn)
      len: 2, # insn_len
      operands: nil,
    ),
    143 => Instruction.new(
      name: :trace_adjuststack,
      bin: 143, # BIN(trace_adjuststack)
      len: 2, # insn_len
      operands: nil,
    ),
    144 => Instruction.new(
      name: :trace_defined,
      bin: 144, # BIN(trace_defined)
      len: 4, # insn_len
      operands: nil,
    ),
    145 => Instruction.new(
      name: :trace_definedivar,
      bin: 145, # BIN(trace_definedivar)
      len: 4, # insn_len
      operands: nil,
    ),
    146 => Instruction.new(
      name: :trace_checkmatch,
      bin: 146, # BIN(trace_checkmatch)
      len: 2, # insn_len
      operands: nil,
    ),
    147 => Instruction.new(
      name: :trace_checkkeyword,
      bin: 147, # BIN(trace_checkkeyword)
      len: 3, # insn_len
      operands: nil,
    ),
    148 => Instruction.new(
      name: :trace_checktype,
      bin: 148, # BIN(trace_checktype)
      len: 2, # insn_len
      operands: nil,
    ),
    149 => Instruction.new(
      name: :trace_defineclass,
      bin: 149, # BIN(trace_defineclass)
      len: 4, # insn_len
      operands: nil,
    ),
    150 => Instruction.new(
      name: :trace_definemethod,
      bin: 150, # BIN(trace_definemethod)
      len: 3, # insn_len
      operands: nil,
    ),
    151 => Instruction.new(
      name: :trace_definesmethod,
      bin: 151, # BIN(trace_definesmethod)
      len: 3, # insn_len
      operands: nil,
    ),
    152 => Instruction.new(
      name: :trace_send,
      bin: 152, # BIN(trace_send)
      len: 3, # insn_len
      operands: nil,
    ),
    153 => Instruction.new(
      name: :trace_opt_send_without_block,
      bin: 153, # BIN(trace_opt_send_without_block)
      len: 2, # insn_len
      operands: nil,
    ),
    154 => Instruction.new(
      name: :trace_objtostring,
      bin: 154, # BIN(trace_objtostring)
      len: 2, # insn_len
      operands: nil,
    ),
    155 => Instruction.new(
      name: :trace_opt_str_freeze,
      bin: 155, # BIN(trace_opt_str_freeze)
      len: 3, # insn_len
      operands: nil,
    ),
    156 => Instruction.new(
      name: :trace_opt_nil_p,
      bin: 156, # BIN(trace_opt_nil_p)
      len: 2, # insn_len
      operands: nil,
    ),
    157 => Instruction.new(
      name: :trace_opt_str_uminus,
      bin: 157, # BIN(trace_opt_str_uminus)
      len: 3, # insn_len
      operands: nil,
    ),
    158 => Instruction.new(
      name: :trace_opt_newarray_send,
      bin: 158, # BIN(trace_opt_newarray_send)
      len: 3, # insn_len
      operands: nil,
    ),
    159 => Instruction.new(
      name: :trace_invokesuper,
      bin: 159, # BIN(trace_invokesuper)
      len: 3, # insn_len
      operands: nil,
    ),
    160 => Instruction.new(
      name: :trace_invokeblock,
      bin: 160, # BIN(trace_invokeblock)
      len: 2, # insn_len
      operands: nil,
    ),
    161 => Instruction.new(
      name: :trace_leave,
      bin: 161, # BIN(trace_leave)
      len: 1, # insn_len
      operands: nil,
    ),
    162 => Instruction.new(
      name: :trace_throw,
      bin: 162, # BIN(trace_throw)
      len: 2, # insn_len
      operands: nil,
    ),
    163 => Instruction.new(
      name: :trace_jump,
      bin: 163, # BIN(trace_jump)
      len: 2, # insn_len
      operands: nil,
    ),
    164 => Instruction.new(
      name: :trace_branchif,
      bin: 164, # BIN(trace_branchif)
      len: 2, # insn_len
      operands: nil,
    ),
    165 => Instruction.new(
      name: :trace_branchunless,
      bin: 165, # BIN(trace_branchunless)
      len: 2, # insn_len
      operands: nil,
    ),
    166 => Instruction.new(
      name: :trace_branchnil,
      bin: 166, # BIN(trace_branchnil)
      len: 2, # insn_len
      operands: nil,
    ),
    167 => Instruction.new(
      name: :trace_once,
      bin: 167, # BIN(trace_once)
      len: 3, # insn_len
      operands: nil,
    ),
    168 => Instruction.new(
      name: :trace_opt_case_dispatch,
      bin: 168, # BIN(trace_opt_case_dispatch)
      len: 3, # insn_len
      operands: nil,
    ),
    169 => Instruction.new(
      name: :trace_opt_plus,
      bin: 169, # BIN(trace_opt_plus)
      len: 2, # insn_len
      operands: nil,
    ),
    170 => Instruction.new(
      name: :trace_opt_minus,
      bin: 170, # BIN(trace_opt_minus)
      len: 2, # insn_len
      operands: nil,
    ),
    171 => Instruction.new(
      name: :trace_opt_mult,
      bin: 171, # BIN(trace_opt_mult)
      len: 2, # insn_len
      operands: nil,
    ),
    172 => Instruction.new(
      name: :trace_opt_div,
      bin: 172, # BIN(trace_opt_div)
      len: 2, # insn_len
      operands: nil,
    ),
    173 => Instruction.new(
      name: :trace_opt_mod,
      bin: 173, # BIN(trace_opt_mod)
      len: 2, # insn_len
      operands: nil,
    ),
    174 => Instruction.new(
      name: :trace_opt_eq,
      bin: 174, # BIN(trace_opt_eq)
      len: 2, # insn_len
      operands: nil,
    ),
    175 => Instruction.new(
      name: :trace_opt_neq,
      bin: 175, # BIN(trace_opt_neq)
      len: 3, # insn_len
      operands: nil,
    ),
    176 => Instruction.new(
      name: :trace_opt_lt,
      bin: 176, # BIN(trace_opt_lt)
      len: 2, # insn_len
      operands: nil,
    ),
    177 => Instruction.new(
      name: :trace_opt_le,
      bin: 177, # BIN(trace_opt_le)
      len: 2, # insn_len
      operands: nil,
    ),
    178 => Instruction.new(
      name: :trace_opt_gt,
      bin: 178, # BIN(trace_opt_gt)
      len: 2, # insn_len
      operands: nil,
    ),
    179 => Instruction.new(
      name: :trace_opt_ge,
      bin: 179, # BIN(trace_opt_ge)
      len: 2, # insn_len
      operands: nil,
    ),
    180 => Instruction.new(
      name: :trace_opt_ltlt,
      bin: 180, # BIN(trace_opt_ltlt)
      len: 2, # insn_len
      operands: nil,
    ),
    181 => Instruction.new(
      name: :trace_opt_and,
      bin: 181, # BIN(trace_opt_and)
      len: 2, # insn_len
      operands: nil,
    ),
    182 => Instruction.new(
      name: :trace_opt_or,
      bin: 182, # BIN(trace_opt_or)
      len: 2, # insn_len
      operands: nil,
    ),
    183 => Instruction.new(
      name: :trace_opt_aref,
      bin: 183, # BIN(trace_opt_aref)
      len: 2, # insn_len
      operands: nil,
    ),
    184 => Instruction.new(
      name: :trace_opt_aset,
      bin: 184, # BIN(trace_opt_aset)
      len: 2, # insn_len
      operands: nil,
    ),
    185 => Instruction.new(
      name: :trace_opt_aset_with,
      bin: 185, # BIN(trace_opt_aset_with)
      len: 3, # insn_len
      operands: nil,
    ),
    186 => Instruction.new(
      name: :trace_opt_aref_with,
      bin: 186, # BIN(trace_opt_aref_with)
      len: 3, # insn_len
      operands: nil,
    ),
    187 => Instruction.new(
      name: :trace_opt_length,
      bin: 187, # BIN(trace_opt_length)
      len: 2, # insn_len
      operands: nil,
    ),
    188 => Instruction.new(
      name: :trace_opt_size,
      bin: 188, # BIN(trace_opt_size)
      len: 2, # insn_len
      operands: nil,
    ),
    189 => Instruction.new(
      name: :trace_opt_empty_p,
      bin: 189, # BIN(trace_opt_empty_p)
      len: 2, # insn_len
      operands: nil,
    ),
    190 => Instruction.new(
      name: :trace_opt_succ,
      bin: 190, # BIN(trace_opt_succ)
      len: 2, # insn_len
      operands: nil,
    ),
    191 => Instruction.new(
      name: :trace_opt_not,
      bin: 191, # BIN(trace_opt_not)
      len: 2, # insn_len
      operands: nil,
    ),
    192 => Instruction.new(
      name: :trace_opt_regexpmatch2,
      bin: 192, # BIN(trace_opt_regexpmatch2)
      len: 2, # insn_len
      operands: nil,
    ),
    193 => Instruction.new(
      name: :trace_invokebuiltin,
      bin: 193, # BIN(trace_invokebuiltin)
      len: 2, # insn_len
      operands: nil,
    ),
    194 => Instruction.new(
      name: :trace_opt_invokebuiltin_delegate,
      bin: 194, # BIN(trace_opt_invokebuiltin_delegate)
      len: 3, # insn_len
      operands: nil,
    ),
    195 => Instruction.new(
      name: :trace_opt_invokebuiltin_delegate_leave,
      bin: 195, # BIN(trace_opt_invokebuiltin_delegate_leave)
      len: 3, # insn_len
      operands: nil,
    ),
    196 => Instruction.new(
      name: :trace_getlocal_WC_0,
      bin: 196, # BIN(trace_getlocal_WC_0)
      len: 2, # insn_len
      operands: nil,
    ),
    197 => Instruction.new(
      name: :trace_getlocal_WC_1,
      bin: 197, # BIN(trace_getlocal_WC_1)
      len: 2, # insn_len
      operands: nil,
    ),
    198 => Instruction.new(
      name: :trace_setlocal_WC_0,
      bin: 198, # BIN(trace_setlocal_WC_0)
      len: 2, # insn_len
      operands: nil,
    ),
    199 => Instruction.new(
      name: :trace_setlocal_WC_1,
      bin: 199, # BIN(trace_setlocal_WC_1)
      len: 2, # insn_len
      operands: nil,
    ),
    200 => Instruction.new(
      name: :trace_putobject_INT2FIX_0_,
      bin: 200, # BIN(trace_putobject_INT2FIX_0_)
      len: 1, # insn_len
      operands: nil,
    ),
    201 => Instruction.new(
      name: :trace_putobject_INT2FIX_1_,
      bin: 201, # BIN(trace_putobject_INT2FIX_1_)
      len: 1, # insn_len
      operands: nil,
    ),
  }
